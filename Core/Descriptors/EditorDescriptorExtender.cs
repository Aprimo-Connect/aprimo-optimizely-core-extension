...
namespace Aprimo.Opti.Core.Descriptors
{
    public static class EditorDescriptorExtender
    {
        ...
        public static void ModifyMetadata(ExtendedMetadata metadata, IEnumerable<Attribute> attributes)
        {
            ...
            metadata.EditorConfiguration["aprimoiconpath"] = $"/episerver/{AprimoConstants.ModuleName}/{AprimoConstants.DBVersion}/clientresources/scripts/editors/images/aprimo_opt_cropped.png";
            ...
            metadata.EditorConfiguration["aprimomodulepath"] = Paths.ToResource(AprimoConstants.ModuleName, string.Empty);
        }
    }
}